...
For now you can open admin page on your favorite browser,

    php artisan webcore:api_scaffold Menu --fieldsFile=Menu.json --skip=routes,menu

    php artisan webcore:api_scaffold Profile --fieldsFile=Profile.json --skip=routes,menu

    php artisan webcore:api_scaffold Setting --fieldsFile=Setting.json --skip=routes,menu

    php artisan webcore:api_scaffold Page --fieldsFile=Page.json --skip=routes,menu

    php artisan webcore:api_scaffold Component --fieldsFile=Component.json --skip=routes,menu

Optional

    php artisan webcore:api_scaffold Post --fieldsFile=Post.json
