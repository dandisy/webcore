...
<li class="{{ Request::is('tests*') ? 'active' : '' }}">
    <a class="{{ Request::is('tests*') ? 'active' : '' }}" href="{!! route('tests.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Tests</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('test2s*') ? 'active' : '' }}">
    <a class="{{ Request::is('test2s*') ? 'active' : '' }}" href="{!! route('test2s.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test2S</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('test3s*') ? 'active' : '' }}">
    <a class="{{ Request::is('test3s*') ? 'active' : '' }}" href="{!! route('test3s.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test3S</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testOks*') ? 'active' : '' }}">
    <a class="{{ Request::is('testOks*') ? 'active' : '' }}" href="{!! route('testOks.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test Oks</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testBaguses*') ? 'active' : '' }}">
    <a class="{{ Request::is('testBaguses*') ? 'active' : '' }}" href="{!! route('testBaguses.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test Baguses</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testDuas*') ? 'active' : '' }}">
    <a class="{{ Request::is('testDuas*') ? 'active' : '' }}" href="{!! route('testDuas.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test Duas</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testTigas*') ? 'active' : '' }}">
    <a class="{{ Request::is('testTigas*') ? 'active' : '' }}" href="{!! route('testTigas.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test Tigas</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testEmpats*') ? 'active' : '' }}">
    <a class="{{ Request::is('testEmpats*') ? 'active' : '' }}" href="{!! route('testEmpats.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test Empats</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>

<li class="{{ Request::is('testDTs*') ? 'active' : '' }}">
    <a class="{{ Request::is('testDTs*') ? 'active' : '' }}" href="{!! route('testDTs.index') !!}">
        <div class="pull-left">
            <i class="fa fa-edit"></i>
            <span class="right-nav-text">Test D Ts</span>
        </div>
        <div class="clearfix"></div>
    </a>
</li>
